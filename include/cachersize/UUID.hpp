 ...
 */
#ifndef __CACHERSIZE_UUID_UTIL_HPP
#define __CACHERSIZE_UUID_UTIL_HPP
...
namespace std {
    ...
    /**
     * @brief Specialization of std::hash for cachersize::UUID
     */
    template<>
    struct hash<cachersize::UUID> 
    {
        size_t operator()(const cachersize::UUID& id) const
        {
            return id.hash();
        }
    };
